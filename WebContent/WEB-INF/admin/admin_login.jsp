    ...
    <div class="row padding">
      ...
      <div class="col-12 col-md-6 " id="mg-login">
        <div class="card" id="account-page"> 
		 ...
		 <%-- <h4 style="font-size: 15px;color:red; margin-top:10px"><%= request.getAttribute("message") %></h4> --%>

          <form action="admin" method="post" id="formdk">
              <input type="text" placeholder="Tên đăng nhập" name="username" required>
              <input type="password" placeholder="Mật khẩu" name="password" required>
              <input type="email" placeholder="Email" name="email" required>
              <button type="submit" class="bt" name="login">Đăng nhập</button>
              <a href="/ECWeb/forget_password" style="text-decoration: none; color: black">Quên mật khẩu?</a>
